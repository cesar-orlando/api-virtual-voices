        ...
        tool({
          ...
          execute: async () => {
            try {
              ...
              const result = 'CURSOS ONLINE - Membresias disponibles: 1 mes ($1,250 MXN), 3 meses + 3 gratis ($3,500 MXN), 6 meses + 3 gratis ($5,700 MXN), 12 meses + 1 gratis ($9,700 MXN). Caracteristicas: Plataforma interactiva 24/7, tabla fonetica a color, reconocimiento de voz, catalogo multimedia extenso, aprendizaje a tu ritmo, sesiones en vivo ilimitadas con profesores, perfecto para dispositivos moviles.';
