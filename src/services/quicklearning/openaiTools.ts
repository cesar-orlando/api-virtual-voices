 ...
 * Esta función permite a la IA crear automáticamente eventos en Google Calendar
 */
export const create_google_calendar_event = async (
  ...
  try {
    ...
    console.log(`📍 Function: create_google_calendar_event`);
    console.log(`🤖 OpenAI Tool Called: create_google_calendar_event`);
    console.log('='.repeat(60));
